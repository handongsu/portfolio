...
export const projectInformation: InforamtionProps[] = [
  {
    title: "Portfolio",
    ...
    skills: [" React.js, TypeScript, CSS, Context-api, Styled-Component, MUI"],
  },
  ...
  {
    title: "FitBuddy",
    link: `https://github.com/FRONTENDSCHOOL7/final-21-FitBuddy`,
